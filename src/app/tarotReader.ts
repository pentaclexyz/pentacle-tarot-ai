    ...
    private async generateTarotImage(
        ...
        try {
            const cardNames = cards
                ...
                .join(', ');
            const prompt = `punk, hand dawn ink style art, fine ink drawing, minimalist, edgy punk manga 1960s style ink anime, 25 year old female japanese tarot reader with ${cardNames} cards laid out, https://s.mj.run/0LLFDv6GwFw`;
