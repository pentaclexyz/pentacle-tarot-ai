        ...
        <>
            <nav className="grid justify-items-end p-4 text-xs">
                <div className="space-x-4 !text-xs">
                    <Button variant="link" onClick={() => sendCommand('help')} disabled={loading}>
                        <span className={"text-xs"}>Help</span>
                    </Button>
                    <Button variant="link" onClick={() => sendCommand('about')} disabled={loading}>
                        <span className={"text-xs"}>About</span>
                    </Button>
                    <Button variant="link" onClick={() => sendCommand('What kind of readings do you do?')} disabled={loading}>
                    ...
                    <div className="grid gap-8">
                        ...
                        {reading && (
                            <div>
                                ...
                                <p className={"pt-2 text-right px-8 w-full"}>image generated by <a href={"https://venice.ai"}
                                                                                                   target={"_blank"}
